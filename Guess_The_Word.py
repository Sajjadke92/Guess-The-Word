...
while rematch or restart:
 if restart or not rematch:  # For starting a new game , not a rematch
 ...
 def choose_random_file():  # Function to choose a random category file
    return random.choice(file_categories)  # Choose a random category from the list
...
# Function to choose a random word from the chosen category file
 ...
 def player_guess(guess):
    ...
    """ takes the guess, and checks the player's guessed letter against the letters in the word.
       If the guessed letter matches any letter in the word, it reveals that letter in the 'hidden_word'.

       It returns the updated 'hidden_word' with the guessed letters revealed.
       Correctly guessed letters are shown, and unguessed letters remain as underscores ('_').

       Example:
        If the word is 'Paris' and the hidden word is ['_','_','_','_','_']:
         After calling player_guess('p'), the hidden word becomes ['p','_','_','_','_']
         After calling player_guess('r'), the hidden word becomes ['p','_','r','_','_'] """
